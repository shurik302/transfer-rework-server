      ...
      <div className='MainInfoTicket'>
        <div className='FromToTicket'>
          <div className='FromTicket'>
            ...
            <span>{language === 'ua' ? travel.additionatlinfoFromUA : travel.additionatlinfoFromEN}</span>
          </div>
          <div className='ToTicket'>
            <span>{getCityNameById(travel.to, language, cities)}</span>
            <span>{language === 'ua' ? travel.additionatlinfoToUA : travel.additionatlinfoToEN}</span>
          </div>
        </div>
